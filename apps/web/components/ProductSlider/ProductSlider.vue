<template>
  <SfScrollable buttons-placement="floating" class="!gap-0 productSlide w-full scrollbar-hidden" :wrapper-class="wrapperClass" data-testid="product-slider" totalItems="4">
