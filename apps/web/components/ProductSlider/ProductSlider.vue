<template>
  <SfScrollable buttons-placement="floating" class="pb-4 !gap-0 productSlide w-full scrollbar-hidden" :wrapper-class="wrapperClass" data-testid="product-slider" totalItems="4">
